...
export const DEFAULT_TEACHERS: TeacherInfo[] = [
  // 7 GIÁO VIÊN CHỦ NHIỆM (KHỐI 1 ĐẾN KHỐI 5)
  { id: "minh_thu_1_1", name: "Minh Thu", role: "GVCN 1.1", type: "homeroom", assignedClasses: ["1.1"], subjects: ["Tiếng Việt", "Toán", "HĐTN"], teachingPeriods: 19, concurrentPeriods: 4, totalPeriods: 23 },
  { id: "phuong_1_2", name: "Phượng", role: "GVCN 1.2", type: "homeroom", assignedClasses: ["1.2"], subjects: ["Tiếng Việt", "Toán", "HĐTN"], teachingPeriods: 19, concurrentPeriods: 4, totalPeriods: 23 },
  { id: "ha_2", name: "Hà", role: "GVCN 2", type: "homeroom", assignedClasses: ["2"], subjects: ["Tiếng Việt", "Toán", "HĐTN", "TCTV"], teachingPeriods: 19, concurrentPeriods: 4, totalPeriods: 23 },
  { id: "phi_3", name: "Phi", role: "GVCN 3", type: "homeroom", assignedClasses: ["3"], subjects: ["Tiếng Việt", "Toán", "Đạo đức", "HĐTN", "Công nghệ"], teachingPeriods: 16, concurrentPeriods: 7, totalPeriods: 23 },
  { id: "thuy_4_1", name: "Thuý", role: "GVCN 4.1", type: "homeroom", assignedClasses: ["4.1"], subjects: ["Tiếng Việt", "Toán", "HĐTN", "Công nghệ"], teachingPeriods: 15, concurrentPeriods: 8, totalPeriods: 23 },
  { id: "het_em_4_2", name: "Hết Em", role: "GVCN 4.2", type: "homeroom", assignedClasses: ["4.2"], subjects: ["Tiếng Việt", "Toán", "Khoa học", "Lịch sử & Địa lí", "HĐTN", "Công nghệ"], teachingPeriods: 19, concurrentPeriods: 4, totalPeriods: 23 },
  ...
  // 8 GIÁO VIÊN BỘ MÔN / CHUYÊN / PHT (TOÀN TRƯỜNG)
  { id: "vu_an", name: "Vũ", role: "GV Chuyên Âm nhạc", type: "specialist", specialistSubject: "Âm nhạc", assignedClasses: ["1.1", "1.2", "2", "3", "4.1", "4.2", "5"], subjects: ["Âm nhạc", "Bồi dưỡng Âm nhạc"], teachingPeriods: 20, concurrentPeriods: 3, totalPeriods: 23 },
  { id: "luong_mt", name: "Lượng", role: "GV Chuyên Mĩ thuật", type: "specialist", specialistSubject: "Mĩ thuật", assignedClasses: ["1.1", "1.2", "2", "3", "4.1", "4.2", "5"], subjects: ["Mĩ thuật"], teachingPeriods: 7, concurrentPeriods: 0, totalPeriods: 7 },
  { id: "cang_bm", name: "Cang", role: "GV Bộ môn (TNXH, LS-ĐL, TCT, TCTV, ĐĐ)", type: "specialist", specialistSubject: "Tự nhiên và Xã hội", assignedClasses: ["1.1", "1.2", "2", "3", "4.1"], subjects: ["Tự nhiên và Xã hội", "Lịch sử và Địa lí", "Tăng cường Toán", "Tăng cường Tiếng Việt", "Đạo đức"], teachingPeriods: 20, concurrentPeriods: 3, totalPeriods: 23 },
  { id: "an_gdtc", name: "Ân", role: "GV Chuyên GDTC & HĐTN", type: "specialist", specialistSubject: "Giáo dục Thể chất", assignedClasses: ["1.1", "1.2", "2", "3", "4.1", "4.2", "5"], subjects: ["Giáo dục Thể chất", "Hoạt động trải nghiệm"], teachingPeriods: 20, concurrentPeriods: 3, totalPeriods: 23 },
  { id: "ngan_bm", name: "Ngân", role: "GV Bộ môn Khoa học & Đạo đức", type: "specialist", specialistSubject: "Khoa học", assignedClasses: ["1.1", "4.1", "5"], subjects: ["Khoa học", "Đạo đức"], teachingPeriods: 5, concurrentPeriods: 0, totalPeriods: 5 },
  { id: "quyen_ta", name: "Quyên", role: "GV Chuyên Tiếng Anh", type: "specialist", specialistSubject: "Tiếng Anh", assignedClasses: ["3", "4.1", "4.2", "5"], subjects: ["Tiếng Anh"], teachingPeriods: 16, concurrentPeriods: 0, totalPeriods: 16 },
  { id: "thao_th", name: "Thảo", role: "GV Chuyên Tin học", type: "specialist", specialistSubject: "Tin học", assignedClasses: ["1.1", "1.2", "2", "3", "4.1", "4.2", "5"], subjects: ["Tin học"], teachingPeriods: 7, concurrentPeriods: 3, totalPeriods: 10 },
...
export const DEFAULT_CLASSES = ["1.1", "1.2", "2", "3", "4.1", "4.2", "5"];
...
export const TIMETABLE_DINH_VAN_PHU_SLOTS: Record<string, Record<string, string>> = {
  // THỨ HAI (21/09/2026)
  "Thứ Hai_Sáng_1": { "1.1": "HĐTN (CC)", "1.2": "HĐTN (CC)", "2": "HĐTN (CC)", "3": "HĐTN (CC)", "4.1": "HĐTN (CC)", "4.2": "HĐTN (CC)", "5": "HĐTN (CC)" },
  "Thứ Hai_Sáng_2": { "1.1": "TV", "1.2": "TV", "2": "TV", "3": "TV", "4.1": "TV", "4.2": "TV", "5": "TV" },
  "Thứ Hai_Sáng_3": { "1.1": "TV", "1.2": "TV", "2": "TV", "3": "TV", "4.1": "TV", "4.2": "TV", "5": "TV" },
  "Thứ Hai_Sáng_4": { "1.1": "T", "1.2": "T", "2": "T", "3": "T", "4.1": "T", "4.2": "T", "5": "T" },
  "Thứ Hai_Sáng_5": { "1.1": "", "1.2": "", "2": "", "3": "", "4.1": "", "4.2": "", "5": "" },

  "Thứ Hai_Chiều_1": { "1.1": "TNXH (Cang)", "1.2": "TCTV", "2": "AN (Vũ)", "3": "TA (Quyên)", "4.1": "HĐTN (ÂN)", "4.2": "TH (Thảo)", "5": "LS-ĐL" },
  "Thứ Hai_Chiều_2": { "1.1": "AN (Vũ)", "1.2": "TNXH (Cang)", "2": "TCTV", "3": "GDTC (ÂN)", "4.1": "TH (Thảo)", "4.2": "TA (Quyên)", "5": "KH (Ngân)" },
  "Thứ Hai_Chiều_3": { "1.1": "TCTV", "1.2": "AN (Vũ)", "2": "TNXH (Cang)", "3": "TH (Thảo)", "4.1": "KH (Ngân)", "4.2": "GDTC (ÂN)", "5": "ĐĐ" },

  // THỨ BA (22/09/2026)
  "Thứ Ba_Sáng_1": { "1.1": "GDTC (ÂN)", "1.2": "TV", "2": "TV", "3": "TNXH (Cang)", "4.1": "TA (Quyên)", "4.2": "TV", "5": "AN (Vũ)" },
  "Thứ Ba_Sáng_2": { "1.1": "TV", "1.2": "GDTC (ÂN)", "2": "TV", "3": "TV", "4.1": "LS-ĐL (Cang)", "4.2": "AN (Vũ)", "5": "TA (Quyên)" },
  "Thứ Ba_Sáng_3": { "1.1": "TV", "1.2": "TV", "2": "GDTC (ÂN)", "3": "TCTV (Cang)", "4.1": "TV", "4.2": "TA (Quyên)", "5": "BDAN (Vũ)" },
  "Thứ Ba_Sáng_4": { "1.1": "BDAN (Vũ)", "1.2": "ĐĐ (Hoài)", "2": "ĐĐ (Cang)", "3": "TA (Quyên)", "4.1": "T", "4.2": "HĐTN (ÂN)", "5": "T" },
  "Thứ Ba_Sáng_5": { "1.1": "", "1.2": "", "2": "", "3": "", "4.1": "", "4.2": "", "5": "" },

  "Thứ Ba_Chiều_1": { "1.1": "TNXH (Cang)", "1.2": "HĐTN (ÂN)", "2": "T", "3": "AN (Vũ)", "4.1": "ĐĐ (Hoài)", "4.2": "T", "5": "TV" },
  "Thứ Ba_Chiều_2": { "1.1": "T", "1.2": "TNXH (Cang)", "2": "TCTV", "3": "T", "4.1": "AN (Vũ)", "4.2": "LS-ĐL", "5": "GDTC (ÂN)" },
  "Thứ Ba_Chiều_3": { "1.1": "TCTV", "1.2": "TCTV", "2": "TNXH (Cang)", "3": "ĐĐ", "4.1": "GDTC (ÂN)", "4.2": "ĐĐ (Hoài)", "5": "LS-ĐL" },

  // THỨ TƯ (23/09/2026)
  "Thứ Tư_Sáng_1": { "1.1": "TCT (Cang)", "1.2": "TV", "2": "GDTC (ÂN)", "3": "TV", "4.1": "TA (Quyên)", "4.2": "TV", "5": "BDAN (Vũ)" },
  "Thứ Tư_Sáng_2": { "1.1": "ĐĐ (Ngân)", "1.2": "TV", "2": "TCT (Cang)", "3": "TV", "4.1": "TV", "4.2": "TV", "5": "TA (Quyên)" },
  "Thứ Tư_Sáng_3": { "1.1": "TV", "1.2": "TCT (Cang)", "2": "T", "3": "GDTC (ÂN)", "4.1": "TV", "4.2": "T", "5": "KH (Ngân)" },
  "Thứ Tư_Sáng_4": { "1.1": "TV", "1.2": "T", "2": "HĐTN (ÂN)", "3": "T", "4.1": "KH (Ngân)", "4.2": "KH", "5": "T" },
  "Thứ Tư_Sáng_5": { "1.1": "", "1.2": "", "2": "", "3": "", "4.1": "", "4.2": "", "5": "" },

  "Thứ Tư_Chiều_1": { "1.1": "HĐTN (ÂN)", "1.2": "TV", "2": "BDAN (Vũ)", "3": "TNXH (Cang)", "4.1": "T", "4.2": "CN", "5": "TA (Quyên)" },
  "Thứ Tư_Chiều_2": { "1.1": "TV", "1.2": "BDAN (Vũ)", "2": "TV", "3": "TA (Quyên)", "4.1": "LS-ĐL (Cang)", "4.2": "GDTC (ÂN)", "5": "TV" },
  "Thứ Tư_Chiều_3": { "1.1": "TV", "1.2": "TV", "2": "TV", "3": "HĐTN (ÂN)", "4.1": "TA (Quyên)", "4.2": "BDAN (Vũ)", "5": "TV" },

  // THỨ NĂM (24/09/2026)
  "Thứ Năm_Sáng_1": { "1.1": "TH (Thảo)", "1.2": "T", "2": "MT (Lượng)", "3": "BDAN (Vũ)", "4.1": "TV", "4.2": "TA (Quyên)", "5": "TV" },
  "Thứ Năm_Sáng_2": { "1.1": "TV", "1.2": "TH (Thảo)", "2": "TCT (Cang)", "3": "MT (Lượng)", "4.1": "BDAN (Vũ)", "4.2": "TV", "5": "TA (Quyên)" },
  "Thứ Năm_Sáng_3": { "1.1": "TV", "1.2": "MT (Lượng)", "2": "TH (Thảo)", "3": "TV", "4.1": "BDAN (Vũ)", "4.2": "T", "5": "T" },
  "Thứ Năm_Sáng_4": { "1.1": "MT (Lượng)", "1.2": "TCT (Cang)", "2": "BDAN (Vũ)", "3": "T", "4.1": "T", "4.2": "LS-ĐL", "5": "TH (Thảo)" },
  "Thứ Năm_Sáng_5": { "1.1": "", "1.2": "", "2": "", "3": "", "4.1": "", "4.2": "", "5": "" },

  "Thứ Năm_Chiều_1": { "1.1": "TCT (Cang)", "1.2": "BDAN (Vũ)", "2": "TV", "3": "TA (Quyên)", "4.1": "CN", "4.2": "MT (Lượng)", "5": "HĐTN (Hoài)" },
  "Thứ Năm_Chiều_2": { "1.1": "T", "1.2": "TV", "2": "TV", "3": "TCT (Cang)", "4.1": "GDTC (ÂN)", "4.2": "BDAN (Vũ)", "5": "MT (Lượng)" },
  "Thứ Năm_Chiều_3": { "1.1": "TCT (Cang)", "1.2": "TV", "2": "T", "3": "BDAN (Vũ)", "4.1": "MT (Lượng)", "4.2": "KH", "5": "GDTC (ÂN)" },

  // THỨ SÁU (25/09/2026)
  "Thứ Sáu_Sáng_1": { "1.1": "GDTC (ÂN)", "1.2": "TV", "2": "TV", "3": "TV", "4.1": "TA (Quyên)", "4.2": "TV", "5": "TV" },
  "Thứ Sáu_Sáng_2": { "1.1": "TV", "1.2": "GDTC (ÂN)", "2": "TV", "3": "T", "4.1": "TV", "4.2": "TA (Quyên)", "5": "T" },
  "Thứ Sáu_Sáng_3": { "1.1": "TV", "1.2": "TV", "2": "T", "3": "CN", "4.1": "T", "4.2": "T", "5": "CN" },
  "Thứ Sáu_Sáng_4": { "1.1": "HĐTN (SHL)", "1.2": "HĐTN (SHL)", "2": "HĐTN (SHL)", "3": "HĐTN (SHL)", "4.1": "HĐTN (SHL)", "4.2": "HĐTN (SHL)", "5": "HĐTN (SHL)" },
  "Thứ Sáu_Sáng_5": { "1.1": "", "1.2": "", "2": "", "3": "", "4.1": "", "4.2": "", "5": "" },

  "Thứ Sáu_Chiều_1": { "1.1": "HỌP", "1.2": "HỌP", "2": "HỌP", "3": "HỌP", "4.1": "HỌP", "4.2": "HỌP", "5": "HỌP" },
  "Thứ Sáu_Chiều_2": { "1.1": "HỌP", "1.2": "HỌP", "2": "HỌP", "3": "HỌP", "4.1": "HỌP", "4.2": "HỌP", "5": "HỌP" },
  "Thứ Sáu_Chiều_3": { "1.1": "HỌP", "1.2": "HỌP", "2": "HỌP", "3": "HỌP", "4.1": "HỌP", "4.2": "HỌP", "5": "HỌP" },
};
